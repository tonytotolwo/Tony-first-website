 ...
 */
class Corporate_Education_Dropdown_Single_Category_Control extends WP_Customize_Control {
...
class Corporate_Education_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @see WP_Customize_Control
 */
class Corporate_Education_Dropdown_Category_Control extends WP_Customize_Control {
...
class Corporate_Education_Note_Control extends WP_Customize_Control {
