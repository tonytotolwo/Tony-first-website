...
function gurukul_education_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('gurukul_education_theme_options',array(
	        'default' => __('Right Sidebar','gurukul-education'),
	        'sanitize_callback' => 'gurukul_education_sanitize_choices'	        
	));

	$wp_customize->add_control('gurukul_education_theme_options',
	    array(
	        'type' => 'radio',
	...
	$wp_customize->add_control('gurukul_education_facebook',array(
		'label'	=> __('Add Link','gurukul-education'),
	...
	$wp_customize->add_setting('gurukul_education_googleplus',array(
		'default'=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));
	
	$wp_customize->add_control('gurukul_education_googleplus',array(
		'label'	=> __('Add Link','gurukul-education'),
		'section'=> 'gurukul_education_contact_details',
		'setting'=> 'gurukul_education_googleplus',
		'type'=> 'url'
	));
	...
	//home page slider
	$wp_customize->add_section( 'gurukul_education_slider' , array(
	...
	for ( $count = 1; $count <= 4; $count++ ) {
		...
		$wp_customize->add_setting( 'gurukul_education_slide_page' . $count, array(
			'default'           => '',
			'sanitize_callback' => 'absint'
		) );

		$wp_customize->add_control( 'gurukul_education_slide_page' . $count, array(
			'label'    => __( 'Select Slide Image Page', 'gurukul-education' ),
			'section'  => 'gurukul_education_slider',
			'type'     => 'dropdown-pages'
		) );
	}
		...
		$manager->add_section(
			new Gurukul_Education_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'  => esc_url( 'https://www.luzuk.com/themes/premium-gurukul-education-wordpress-theme/' ),
				)
			)
		);
	}
